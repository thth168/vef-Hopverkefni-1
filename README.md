Til þess að keyra verkefnið þarf maður að opna node.js command prompt, fara í möppu sem inniheldur verkefnið og keyra með npm run dev.

Í aðal möppunni eru 3 möppur og 12 skrár utan mappa sem verkefnið notar. Fyrsta mappan heitir "img" þar sem allar myndirnar eru
